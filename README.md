...
For instance, you can connect to the movie recommendations database and
query it as follows.
...
[documentation](https://neo4j.com/docs/getting-started/whats-neo4j/#_installing_neo4j).
...
The following chunks show how to instantiate a Docker container running
Neo4j version 3, 4, or 5. The main differences between the calls are
related to the APOC library and SSL configuration.
