...
In recent versions of Neo4j (2025 and later), the APOC jar is now bundled in the image. The `NEO4J_PLUGINS` environment variable automatically copies it in at container start, and persisting `/plugins` avoids re-copying on every restart.
